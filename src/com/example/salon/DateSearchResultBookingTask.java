...
public class DateSearchResultBookingTask extends AsyncTask<String,Integer,String>{
    
	String Schedule_id="NA";
	
	DateSearchResult activity;
	DateSearchResultBookingTask(DateSearchResult activity2){
	        	...
	        	StrictMode.setThreadPolicy(policy);
	     			...
	     			jsonParser json = new jsonParser(DateSearchResult.CON);
	     			 ...
	     			 json.SetUrl(JsonUrl.ApiUrl+"bookingcart/bsession_update_booking/format/json"); 
	     	           ...
	     	           json.SetParams("SartTime",DateSearchResult.selected_startTime);
	     	           json.SetParams("Endtime",DateSearchResult.selected_endTime);
	...
	protected void onPostExecute(String result) {
		// TODO Auto-generated method stub
		DateSearchResult.mDialog.dismiss();
	...
	protected void onPreExecute() {
		...
		DateSearchResult.mDialog.setMessage("Booking your appointment...");
