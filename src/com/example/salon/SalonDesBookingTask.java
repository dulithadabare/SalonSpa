...
public class SalonDesBookingTask extends AsyncTask<String,Integer,String>{
     
	String Schedule_id="NA";
	
	 SalonDescriptionFragment activity;
	 SalonDesBookingTask(SalonDescriptionFragment activity2){
	        	...
	        	StrictMode.setThreadPolicy(policy);
	     			...
	     			jsonParser json = new jsonParser(SalonDescriptionFragment.CON);
	     			 ...
	     			 json.SetUrl(JsonUrl.ApiUrl+"bookingcart/bsession_update_booking/format/json"); 
	     	           ...
	     	           json.SetParams("SartTime",SalonDescriptionFragment.selected_startTime);
	     	           json.SetParams("Endtime",SalonDescriptionFragment.selected_endTime);
	...
	protected void onPreExecute() {
		...
		SalonDescriptionFragment.mDialog.setMessage("Booking your appointment...");
