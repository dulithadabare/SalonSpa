...
public class DateSearchResultUserCreateTask extends AsyncTask<String,Integer,String>{

	 String errorMessage="error";
	 DateSearchResult activity;
	 DateSearchResultUserCreateTask( DateSearchResult activity2){
	...
	protected void onPreExecute() {
		...
		DateSearchResult.mDialog.setMessage("Logging in..");
