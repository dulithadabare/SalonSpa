...
public class UnifiedStylistFragmentAdapter extends BaseAdapter {
    ...
    public UnifiedStylistFragmentAdapter(Context a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public void filter(String charText) {
        ...
        if(data.isEmpty()){
        	UnifiedStylistFragment.no_result_layout.setVisibility(View.VISIBLE);
        }else{
        	UnifiedStylistFragment.no_result_layout.setVisibility(View.GONE);
        }
