...
public class ServiceFragmentGetUserDetails extends AsyncTask<Void, Void, Void>{
    ...
    protected ServiceSearchFragment mActivity;

    protected String mScope;
    protected String mEmail;
    protected int mRequestCode;

    ServiceFragmentGetUserDetails(ServiceSearchFragment activity, String email, String scope, int requestCode) {
    ...
    protected  String fetchToken() throws IOException{
    	 ...
    	 try {
             return GoogleAuthUtil.getToken(ServiceSearchFragment.CON, mEmail, mScope);
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          return;
            ...
            GoogleAuthUtil.invalidateToken(ServiceSearchFragment.CON, token);
	...
	protected void onPostExecute(Void result) {
		...
		if(ActivityMain.salonspa_user_googleid.equals("NA")){
			ServiceSearchFragment.mDialog.dismiss();
		}
		...
		new ServiceFragmentUserCreateTask(mActivity).execute();
		}
