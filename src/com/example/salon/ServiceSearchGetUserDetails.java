...
public class ServiceSearchGetUserDetails extends AsyncTask<Void, Void, Void>{
    ...
    protected ServiceSearch mActivity;

    protected String mScope;
    protected String mEmail;
    protected int mRequestCode;

    ServiceSearchGetUserDetails(ServiceSearch activity, String email, String scope, int requestCode) {
    ...
    protected  String fetchToken() throws IOException{
    	 ...
    	 try {
             return GoogleAuthUtil.getToken(ServiceSearch.CON, mEmail, mScope);
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          return;
            ...
            GoogleAuthUtil.invalidateToken(ServiceSearch.CON, token);
	...
	protected void onPostExecute(Void result) {
		...
		new ServiceSearchUserCreateTask(mActivity).execute();
		}
