...
public class ServiceFragmentUserCreateTask extends AsyncTask<String,Integer,String>{

	 String errorMessage="error";
	 ServiceSearchFragment activity;
	 ServiceFragmentUserCreateTask(ServiceSearchFragment activity2){
	...
	protected void onPreExecute() {
		...
		ServiceSearchFragment.mDialog.setMessage("Logging in..");
