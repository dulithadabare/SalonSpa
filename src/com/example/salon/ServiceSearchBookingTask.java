...
public class ServiceSearchBookingTask extends AsyncTask<String,Integer,String>{
    
	String Schedule_id="NA";
	
	ServiceSearch activity;
	 ServiceSearchBookingTask(ServiceSearch activity2){
	        	...
	        	StrictMode.setThreadPolicy(policy);
	     			...
	     			jsonParser json = new jsonParser(ServiceSearch.CON);
	     			 ...
	     			 json.SetUrl(JsonUrl.ApiUrl+"bookingcart/bsession_update_booking/format/json"); 
	     	           ...
	     	           json.SetParams("SartTime",ServiceSearch.selected_startTime);
	     	           json.SetParams("Endtime",ServiceSearch.selected_endTime);
	...
	protected void onPreExecute() {
		...
		ServiceSearch.mDialog.setMessage("Booking your appointment...");
