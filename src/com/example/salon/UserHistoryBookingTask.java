...
public class UserHistoryBookingTask extends AsyncTask<String,Integer,String>{
    
	String Schedule_id="NA";
	
	UserHistoryFragment activity;
	UserHistoryBookingTask(UserHistoryFragment activity2){
	        	...
	        	StrictMode.setThreadPolicy(policy);
	     			...
	     			jsonParser json = new jsonParser(UserHistoryFragment.CON);
	     			 ...
	     			 json.SetUrl(JsonUrl.ApiUrl+"bookingcart/bsession_update_booking/format/json"); 
	     	           ...
	     	           json.SetParams("SartTime",UserHistoryFragment.selected_startTime);
	     	           json.SetParams("Endtime",UserHistoryFragment.selected_endTime);
	...
	protected void onPostExecute(String result) {
		// TODO Auto-generated method stub
		UserHistoryFragment.mDialog.dismiss();
	//	ServiceSearchFragment.ServiceAdapter=result;
		//ServiceSearchFragment.list.setAdapter(result);
		 if(Schedule_id.equals("NA")){
   	   ...
   	   activity.show_toast("Booking was successfull! You can manage yoor appointments in the user profile.");
	...
	protected void onPreExecute() {
		...
		UserHistoryFragment.mDialog.show();
		UserHistoryFragment.mDialog.setMessage("Booking your appointment...");
