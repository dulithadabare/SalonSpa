...
public class ServiceSearchUserCreateTask extends AsyncTask<String,Integer,String>{

	 String errorMessage="error";
	 ServiceSearch activity;
	 ServiceSearchUserCreateTask(ServiceSearch activity2){
	...
	protected void onPreExecute() {
		...
		ServiceSearch.mDialog.setMessage("Logging in..");
