...
public class ServiceFragmentBookingTask extends AsyncTask<String,Integer,String>{
    
	String Schedule_id="NA";
	
	ServiceSearchFragment activity;
	 ServiceFragmentBookingTask(ServiceSearchFragment activity2){
	        	...
	        	StrictMode.setThreadPolicy(policy);
	     			...
	     			jsonParser json = new jsonParser(ServiceSearchFragment.CON);
	     			 ...
	     			 json.SetUrl(JsonUrl.ApiUrl+"bookingcart/bsession_update_booking/format/json"); 
	     	           ...
	     	           json.SetParams("SartTime",ServiceSearchFragment.selected_startTime);
	     	           json.SetParams("Endtime",ServiceSearchFragment.selected_endTime);
	...
	protected void onPreExecute() {
		...
		ServiceSearchFragment.mDialog.setMessage("Booking your appointment...");
