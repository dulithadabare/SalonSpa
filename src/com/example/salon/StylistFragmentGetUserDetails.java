...
public class StylistFragmentGetUserDetails extends AsyncTask<Void, Void, Void>{
    ...
    protected StylistSearchFragment mActivity;

    protected String mScope;
    protected String mEmail;
    protected int mRequestCode;

    StylistFragmentGetUserDetails(StylistSearchFragment activity, String email, String scope, int requestCode) {
    ...
    protected  String fetchToken() throws IOException{
    	 ...
    	 try {
             return GoogleAuthUtil.getToken(StylistSearchFragment.CON, mEmail, mScope);
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          return;
            ...
            GoogleAuthUtil.invalidateToken(StylistSearchFragment.CON, token);
	...
	protected void onPostExecute(Void result) {
		...
		new StylistFragmentUserCreateTask(mActivity).execute();
		}
