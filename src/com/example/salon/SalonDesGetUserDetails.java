...
public class SalonDesGetUserDetails extends AsyncTask<Void, Void, Void>{
    ...
    protected SalonDescriptionFragment mActivity;

    protected String mScope;
    protected String mEmail;
    protected int mRequestCode;

    SalonDesGetUserDetails(SalonDescriptionFragment activity, String email, String scope, int requestCode) {
    ...
    protected  String fetchToken() throws IOException{
    	 ...
    	 try {
             return GoogleAuthUtil.getToken(SalonDescriptionFragment.CON, mEmail, mScope);
    ...
    private void fetchNameFromProfileServer() throws IOException, JSONException {
        ...
        if (sc == 200) {
          ...
          return;
            ...
            GoogleAuthUtil.invalidateToken(SalonDescriptionFragment.CON, token);
	...
	protected void onPostExecute(Void result) {
		...
		if(ActivityMain.salonspa_user_googleid.equals("NA")){
			SalonDescriptionFragment.mDialog.dismiss();
		}
		...
		new SalonDesUserCreateTask(mActivity).execute();
		}
