...
public class AppointmentHistoryAdapter extends BaseAdapter {
    ...
    public AppointmentHistoryAdapter(Context a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.row_appointment_history, null);
    ...
    public void filter(String charText) {
        ...
        if(data.isEmpty()){
        	UserHistoryFragment.no_result_layout.setVisibility(View.VISIBLE);
        }else{
        	UserHistoryFragment.no_result_layout.setVisibility(View.GONE);
        }
