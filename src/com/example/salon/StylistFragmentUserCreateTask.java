...
public class StylistFragmentUserCreateTask extends AsyncTask<String,Integer,String>{

	 String errorMessage="error";
	 StylistSearchFragment activity;
	 StylistFragmentUserCreateTask(StylistSearchFragment activity2){
	...
	protected void onPreExecute() {
		...
		StylistSearchFragment.mDialog.setMessage("Logging in..");
