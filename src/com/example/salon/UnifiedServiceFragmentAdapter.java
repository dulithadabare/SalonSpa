...
public class UnifiedServiceFragmentAdapter extends BaseAdapter {
    ...
    public UnifiedServiceFragmentAdapter(Context a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public void filter(String charText) {
        ...
        if(data.isEmpty()){
        	UnifiedServiceFragment.no_result_layout.setVisibility(View.VISIBLE);
        }else{
        	UnifiedServiceFragment.no_result_layout.setVisibility(View.GONE);
        }
